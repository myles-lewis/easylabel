...
# Label peaks automatically
easyManhattan(SLE_gwas, npeaks = 20)
...
* Plotly's `scattergl` function, which uses webGL, seems to have a limit of 
  ...
  app becomes sluggish or freezes and becomes unusable. We try to limit plots 
  to around 100,000 points using the `plotly_filter` argument. See 
  [plotly_filter].
