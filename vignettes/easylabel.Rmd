...
make sense to rasterise the points by clicking the "Raster points" checkbox and
...
`loadlabel()` can either refer directly to the rds file, or can point to the rds
file loaded into the global environment as a list object of class 'easylab'.
